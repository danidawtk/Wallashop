...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-02-2022 a las 15:25:28
...
(69, 'Fotaza', 'fotaza', '1000', 'http://localhost/EL_TRABAJAZO/backend/images/SIN-IMAGEN.jpg', '2022-01-11 13:00:49', 'Otros', 4),
...
(86, 'Vendo azuzar', 'Azucar azucarado', '32', 'http://localhost/EL_TRABAJAZO/backend/images/SIN-IMAGEN.jpg', '2022-02-15 17:14:55', 'Alimentacion', 4),
(87, 'Vendo radiador', 'dsads', '10', 'http://localhost/EL_TRABAJAZO/backend/images/SIN-IMAGEN.jpg', '2022-02-16 17:23:48', 'Decoracion', 4);
...
(4, 'Daniel', 'abeng', '$2y$10$NZLtyuGB9clyrIe3SbEdRuJGmr5KUqUf1kNtWWJncVg3YbTdh82Aq', 'Alc', 'Ciud', 'a@aa', '31221312', 'http://localhost/EL_TRABAJAZO/backend/images/p-4-1642177431.jpg'),
...
--
ALTER TABLE `anuncio`
  MODIFY `idanu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
...
--
ALTER TABLE `anuncio`
  ADD CONSTRAINT `anuncio_ibfk_1` FOREIGN KEY (`idanunciante`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
